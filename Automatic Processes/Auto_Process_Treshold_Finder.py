...
def execute_python_script(script_path):
    ...
    """
    try:
        process = subprocess.run(['python', script_path], capture_output=True, text=True, check=False)
...
for Gaussian_Width in [30, 100] :
    ...
    output_path2 = os.path.join(config_output_path, r"tmp\Normal_RMSD_Matrix_Generator_Input") 
    ...
    execute_python_script(r"C:\Users\keyva\Desktop\Codes\Single Tasks\File_Extraction.py")
    ...
    scripts_to_execute_1 = [
        r"C:\Users\keyva\Desktop\Codes\Single Tasks\Normalized_Intensity_RMSD_Matrix_Generator.py",
    ...
    execute_python_script(r"C:\Users\keyva\Desktop\Codes\Single Tasks\RMSD_Matrix_Average_Calculator.py")

    # Part 4 : cut RMSD Files from tmp to Main Result directory

    input_Path5 = os.path.join(config_output_path, r"tmp\Normalized_Intensity_RMSD_Matrix_Output") 
    write_parameter_to_config(config_file, 'File_Extraction', 'source_folder', input_Path5)


    output_path5 = os.path.join(config_output_path, f"Normal_RMSD_Matrices\{Gaussian_Width} SD")
...
execute_python_script(r"C:\Users\keyva\Desktop\Codes\Single Tasks\Delete_Contents.py")
...
for column in ["W-W_Ave", "W-M_Ave", "M-M_Ave", "Total_Ave", "W-W and M-W Difference_Ave", "W-W_Min", "W-M_Min", "M-M_Min", "Total_Min"] :
    ...
    execute_python_script(r"C:\Users\keyva\Desktop\Codes\Single Tasks\Threshold_Finder.py")
